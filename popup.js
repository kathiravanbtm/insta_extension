...
function applySettingsToUI(settings) {
  ...
  document.getElementById('enableCrop').classList.toggle('active', settings.enableCrop);
...
function bindEvents() {
  ...
  document.getElementById('enableCrop').addEventListener('click', (e) => {
    toggleSetting(e.target, 'enableCrop');
  });
